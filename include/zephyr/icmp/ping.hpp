...
#ifndef __ZEPHYR_PING_HPP__
#define __ZEPHYR_PING_HPP__
...
#include <zephyr/icmp/detail/ipv6_header.hpp>
...
namespace zephyr::detail
{
	...
	protected:
		...
		void _handle_recv(const error_code& ec, std::size_t bytes_recvd)
		{
			...
			ZEPHYR_ASSERT(ipv4_hdr.total_length() == bytes_recvd);
