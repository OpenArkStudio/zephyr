...
#ifndef __ZEPHYR_RPC_INVOKER_HPP__
#define __ZEPHYR_RPC_INVOKER_HPP__
	...
	public:
		...
		inline self& bind(std::string const& name, F&& fun, C&&... obj)
		{
#if defined(_DEBUG) || defined(DEBUG)
			{
				...
				ZEPHYR_ASSERT(this->invokers_.find(name) == this->invokers_.end());
			}
#endif
...
#endif // !__ZEPHYR_RPC_INVOKER_HPP__
