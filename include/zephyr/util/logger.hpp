...
#ifndef __ZEPHYR_LOGGER_HPP__
#define __ZEPHYR_LOGGER_HPP__
...
// when use logger in multi module(eg:exe and dll),should #define ZEPHYR_LOGGER_MULTI_MODULE
// #define ZEPHYR_LOGGER_MULTI_MODULE
...
/*
 ...
 # why use "ZEPHYR_LOGGER_MULTI_MODULE" and create the file in a thread ? when call std::ofstream::open in exe module,and close file in
...
#if defined(ZEPHYR_LOGGER_MULTI_MODULE)
			std::thread t([this]()
			{
				while (true)
				{
