...
#ifndef __ZEPHYR_CONNECT_COMPONENT_HPP__
#define __ZEPHYR_CONNECT_COMPONENT_HPP__
	...
	protected:
			...
			std::shared_ptr<derived_t> this_ptr, condition_wrap<MatchCondition> condition)
		{
			try
			{
				...
				// Connect succeeded. set the keep-alive values
...
#endif // !__ZEPHYR_CONNECT_COMPONENT_HPP__
