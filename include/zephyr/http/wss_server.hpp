...
#ifndef __ZEPHYR_WSS_SERVER_HPP__
#define __ZEPHYR_WSS_SERVER_HPP__
...
namespace zephyr::detail
{
	...
	public:
		...
		explicit wss_server_impl_t(
			...
			: super(method, tcp_silence_timeout, init_buffer_size, max_buffer_size, concurrency)
		{
		}
	...
	public:
		 ...
		 * Function signature : void(std::shared_ptr<zephyr::wss_session>& session_ptr, asio::error_code ec)
		 */
...
#endif // !__ZEPHYR_WSS_SERVER_HPP__
