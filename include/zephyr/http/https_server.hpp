...
#ifndef __ZEPHYR_HTTPS_SERVER_HPP__
#define __ZEPHYR_HTTPS_SERVER_HPP__
...
namespace zephyr::detail
{
	...
	public:
		 ...
		 * Function signature : void(std::shared_ptr<zephyr::https_session>& session_ptr, http::request<http::string_body>& req)
		 */
...
#endif // !__ZEPHYR_HTTPS_SERVER_HPP__
