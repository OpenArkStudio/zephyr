...
#ifndef __ZEPHYR_UDP_CAST_HPP__
#define __ZEPHYR_UDP_CAST_HPP__
...
#include <zephyr/base/component/active_time_cp.hpp>
#include <zephyr/base/component/user_data_cp.hpp>
#include <zephyr/base/component/socket_cp.hpp>
#include <zephyr/base/component/user_timer_cp.hpp>
#include <zephyr/base/component/post_cp.hpp>
#include <zephyr/base/component/event_queue_cp.hpp>

#include <zephyr/base/detail/linear_buffer.hpp>
#include <zephyr/udp/component/udp_send_cp.hpp>
...
namespace zephyr
{
	 ...
	 */
	class udp_cast : public detail::udp_cast_impl_t<udp_cast, asio::ip::udp::socket, zephyr::linear_buffer>
	{
	public:
		using udp_cast_impl_t<udp_cast, asio::ip::udp::socket, zephyr::linear_buffer>::udp_cast_impl_t;
	};
}

#endif // !__ZEPHYR_UDP_CAST_HPP__
